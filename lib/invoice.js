...
/**
 * Streams a PDF invoice to the given writable stream (e.g. an HTTP response or file stream).
 * items: array of { type_name, quality_name, quantity, price_per_bottle, subtotal }
 * copyType: 'client' or 'admin'
 */
function generateInvoicePDF({ stream, delivery, items, company, copyType }) {
